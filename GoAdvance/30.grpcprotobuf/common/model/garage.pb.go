...
func (*GarageCoordinate) Descriptor() ([]byte, []int) {
	return fileDescriptor_garage_0a91488712b067b7, []int{0}
}
...
func (*Garage) Descriptor() ([]byte, []int) {
	return fileDescriptor_garage_0a91488712b067b7, []int{1}
}
...
func (*GarageList) Descriptor() ([]byte, []int) {
	return fileDescriptor_garage_0a91488712b067b7, []int{2}
}
...
func (*GarageListByUser) Descriptor() ([]byte, []int) {
	return fileDescriptor_garage_0a91488712b067b7, []int{3}
}
...
func (*GarageUserId) Descriptor() ([]byte, []int) {
	return fileDescriptor_garage_0a91488712b067b7, []int{4}
}
...
func (*GarageAndUserId) Descriptor() ([]byte, []int) {
	return fileDescriptor_garage_0a91488712b067b7, []int{5}
}
...
func init() { proto.RegisterFile("garage.proto", fileDescriptor_garage_0a91488712b067b7) }

var fileDescriptor_garage_0a91488712b067b7 = []byte{
